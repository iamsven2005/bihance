...
var Button = React.forwardRef(function (_a, ref) {
    var className = _a.className, variant = _a.variant, size = _a.size, _b = _a.asChild, asChild = _b === void 0 ? false : _b, Icon = _a.Icon, iconPlacement = _a.iconPlacement, props = __rest(_a, ["className", "variant", "size", "asChild", "Icon", "iconPlacement"]);
    ...
    return (React.createElement(Comp, __assign({ className: utils_1.cn(buttonVariants({ variant: variant, size: size, className: className })), ref: ref }, props),
        Icon && iconPlacement === "left" && (React.createElement("div", { className: "w-0 translate-x-[0%] pr-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-100 group-hover:pr-2 group-hover:opacity-100" },
            React.createElement(Icon, null))),
        React.createElement(react_slot_1.Slottable, null, props.children),
        Icon && iconPlacement === "right" && (React.createElement("div", { className: "w-0 translate-x-[100%] pl-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-0 group-hover:pl-2 group-hover:opacity-100" },
            React.createElement(Icon, null)))));
});
