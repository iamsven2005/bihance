...
var AccordionTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(AccordionPrimitive.Header, { className: "flex" },
        React.createElement(AccordionPrimitive.Trigger, __assign({ ref: ref, className: utils_1.cn("flex flex-1 items-center justify-between py-4 font-medium transition-all hover:underline [&[data-state=open]>svg]:rotate-180", className) }, props),
            children,
