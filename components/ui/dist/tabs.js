...
var TabsList = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(TabsPrimitive.List, __assign({ ref: ref, className: utils_1.cn("inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground", className) }, props)));
});
